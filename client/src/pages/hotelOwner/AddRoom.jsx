...
const AddRoom = () => {
  ...
  return (
    ...
    enhance the user booking experience"
      ...
      <div className="-full flex max-sm:flex-col sm:gap-4 mt-4">
        <div className="flex-1 max-w-48">
          <p className="text-gray-800 mt-4">Room Type</p>
          <select
            value={inputs.roomType}
            onChange={(e) => setInputs({ ...inputs, roomType: e.target.value })}
            className="border opacity-70 border-gray-30 mt-1 rounded p-2 w-full"
          >
      ...
      <button className="bg-primary text-white p-8 py-2 rounded mt-8 cursor-pointer ">
        Add Room
      </button>
    </form>
  );
