      ...
      <div className="max-w-6xl mt-8 w-ful text-gray-800">
        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            {/* payment Status */}
            <div className="flex flex-col ites-start justify-center pt-3">
              ...
              {!booking.isPaid && (
                <button
                  className="px-4 py-1.5 mt-4 text-m border border-gray-400 rounded-full hover:bg-gray-50 transition -all
                cursor-pointer"
                >
                  Pay Now
                </button>
